...
import { OrbChanges, OrbFiles, OrbPty, OrbPtyWebSocket as OrbPtyWs } from "@rika/orb"
...
export type OrbPtySocketData = OrbPtyWs.OrbPtySocketData
export type OrbPtyWebSocket = OrbPtyWs.OrbPtyWebSocket
export const orbPtyWebSocketHandler = OrbPtyWs.orbPtyWebSocketHandler
export const openOrbPtyWebSocket = OrbPtyWs.openOrbPtyWebSocket
export const messageOrbPtyWebSocket = OrbPtyWs.messageOrbPtyWebSocket
export const drainOrbPtyWebSocket = OrbPtyWs.drainOrbPtyWebSocket
export const closeOrbPtyWebSocketHandler = OrbPtyWs.closeOrbPtyWebSocketHandler

const upgradeOrbPty = (
  orbPty: OrbPty.Interface,
  diagnostics: Diagnostics.Interface,
  request: Request,
  server: OrbPtyWs.OrbPtyUpgradeServer,
  requiredToken: string | undefined,
  orbMode: OrbRouteMode | undefined,
) => OrbPtyWs.upgradeOrbPty(orbPty, diagnostics, request, server, requiredToken, orbMode)
