                          ...
                          return Effect.sync(() => {
                            ...
                            const count =
                              kind === "burst-events"
                                ? 1_000
                                : (() => {
                                    if (kind === "overflow-events" || kind === "queue-overflow-events") {
                                      return 10
                                    }
                                    return 1
                                  })()
                            ...
                            Effect.flatMap((started) =>
                              !started
                                ...
                                : (() => {
                                    ...
                                    return input.prompt[0] === "overflow-watch"
                                      ? Effect.sync(() => {
                                      ...
                                      if (prompt.startsWith("serialized-")) {
                                        return Effect.gen(function* () {
                                          ...
                                          const execution = Effect.gen(function* () {
                                            ...
                                            const completions = yield* Ref.updateAndGet(
                                            ...
                                            if (completions.length === 4) {
                                              ...
                                              yield* fs
                                                .writeFileString(
                                                  path.join(dataRoot, "interactive-serialization.json"),
                                                  encoded,
                                                )
                                                .pipe(Effect.orDie)
                                            }
                                          ...
                                          Effect.ensuring(Ref.update(interactiveAdmissionActive, (value) => value - 1)),
                                        )
                                      }
                                      return Effect.void
                                    })(),
