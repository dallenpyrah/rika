...
| Orb usage visibility                | Implemented running-minute intervals and `rika orb usage`; billing remains out of scope.   | `packages/persistence/src/orb-store.ts`, `packages/cli/src/orb.ts`                 |
