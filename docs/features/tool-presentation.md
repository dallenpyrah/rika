...
| -------------------------------------------------------- | -------------------------------- | ------------------------------- | ---------------------- |
| `read_file`, `read`, `view_file`, `get_diagnostics`      | `Exploring`                      | `Explored`                      | `Read <path>`          |
| `view_media`                                             | `Exploring`                      | `Explored`                      | `Viewed <path>`        |
| `git_status`                                             | `Exploring`                      | `Explored`                      | `Checked <detail>`     |
| `grep`, `ripgrep`                                        | `Exploring`                      | `Explored`                      | `Grep <query>`         |
| `find_files`, `glob`                                     | `Exploring`                      | `Explored`                      | `Searched <query>`     |
| `find_thread`                                            | `Exploring`                      | `Explored`                      | `Searched <query>`     |
| `skill`                                                  | `Exploring`                      | `Explored`                      | the skill name         |
| `create_file`, `write_file`                              | `Creating <path>`                | `Created <path>`                | the live or final diff |
| `edit_file`, `apply_patch`                               | `Editing <path>`                 | `Edited <path>`                 | the live or final diff |
| `shell`, `bash`, `shell_command`, `run_terminal_command` | `$ <command>`                    | `$ <command>`                   | bounded command output |
